	...
	public static void main(String[] args) {
		try {
	        ...
	        if (StringUtils.isEmpty(neo4jVersion))
	            throw new IllegalArgumentException("Neo4j Version not be empty");
	        ...
	        if (StringUtils.isEmpty(archVersion))
	            throw new IllegalArgumentException("Architecture Version not be empty");
	        ...
	        if (StringUtils.isEmpty(googleVersion))
	            throw new IllegalArgumentException("Google Version not be empty");
	        ...
	        if (StringUtils.isEmpty(buildNumberFile))
	            throw new IllegalArgumentException("Build Number File cannot be empty");
	        ...
	        Files.write(Paths.get(neo4jNexusFolder, "data/version"), version.getBytes());
